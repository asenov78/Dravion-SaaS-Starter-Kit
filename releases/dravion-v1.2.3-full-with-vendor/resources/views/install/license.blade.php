...
<form method="POST" action="{{ route('install.process', 'license') }}">
    ...
    <div style="margin-bottom:24px;">
        <x-ui.input name="purchase_code" label="Purchase Code" :value="old('purchase_code')" :error="$errors->first('purchase_code')" required placeholder="e.g. a1b2c3d4-e5f6-7890-abcd-ef1234567890" />
