...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
    ...
    <div class="text-center mb-16">
        <div class="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-brand-50 dark:bg-brand-500/10 text-brand-500 mb-6">
        ...
        <h1 class="text-3xl sm:text-4xl font-extrabold text-gray-900 dark:text-white mb-4">{{ __('gallery.title') }}</h1>
        <p class="text-lg text-gray-500 dark:text-gray-400 max-w-xl mx-auto">{{ __('gallery.subtitle') }}</p>
    </div>
