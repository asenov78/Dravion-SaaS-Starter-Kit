...
$tag  = $href ? 'a' : $tag;
$base = "{$styles} {$padding} border-radius:7px; font-weight:500; cursor:pointer; font-family:Inter,system-ui; transition:background 120ms; line-height:1.4; text-decoration:none; display:inline-flex; align-items:center; gap:6px;";
@endphp
