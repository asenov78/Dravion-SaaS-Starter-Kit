...
{{-- ═══════════ SIDEBAR ═══════════ --}}
<aside style="background:transparent; border-right:1px solid #1e1e27; display:flex; flex-direction:column; flex-shrink:0; height:100%; transition:width 0.2s ease; overflow:hidden; position:relative; z-index:1;"
