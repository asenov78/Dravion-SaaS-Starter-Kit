...
<div class="mt-6 rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 divide-x divide-y divide-gray-100 dark:divide-gray-800">
        @php
        $healthItems = [
            ['label' => __('dashboard.health_php'),          'value' => 'PHP ' . $health['php_version']],
            ['label' => __('dashboard.health_laravel'),      'value' => 'v' . $health['laravel_version']],
            ['label' => __('dashboard.health_memory_limit'), 'value' => $health['memory_limit']],
            ['label' => __('dashboard.health_max_upload'),   'value' => $health['max_upload']],
            ['label' => __('dashboard.health_disk_used'),    'value' => $health['disk_used_pct'] . '%',
             'warn' => $health['disk_used_pct'] > 85],
            ['label' => __('dashboard.health_disk_free'),    'value' => $health['disk_free_gb'] . ' GB'],
            ['label' => __('dashboard.health_db_size'),      'value' => $health['db_size_kb'] . ' KB'],
            ['label' => __('dashboard.health_cache_driver'), 'value' => $health['cache_driver']],
        ];
        @endphp
...
{{-- Scheduler / Cron --}}
<div class="mt-5 rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
    <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between">
        <div class="flex items-center gap-3">
